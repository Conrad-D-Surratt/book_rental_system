...
class Book:
    ...
    # Updated for cleaner, more accessible display
...
if page == "Add Rental":
    ...
    with st.form("input_form", clear_on_submit=True):
        ...
        title = st.text_input("Enter Book Title").strip() # Simon's fix: .strip() handles whitespace-only entries
    ...
    if submitted:
        if title: # Correctly evaluates to False if title is empty or just spaces (thanks to .strip())
...
# --- PAGE: VIEW HISTORY ---
    ...
    if not all_books:
        ...
        # Convert objects to a list of dictionaries for Pandas
